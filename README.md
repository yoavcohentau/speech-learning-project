...
**Notes:**
- Change `DATA_SET_PATH` to point to your local LibriSpeech folder.
- If you want to save audio files or plot graphs, change the consts at the top of the script (`PLOT_AND_SAVE_FLAG`, `EXAMPLE_IDX_TO_SAVE`, `SNR_TO_SAVE`, `T60_TO_SAVE`).
